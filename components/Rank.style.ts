...
const slideupAnimation = (h: string) => keyframes`
  0% {
  ...
  20% {
    transform: translateY(calc(${h} * -2));
  }
  28% {
    transform: translateY(calc(${h} * -2));
  }
  30% {
    transform: translateY(calc(${h} * -3));
  }
  38% {
    transform: translateY(calc(${h} * -3));
  }
  40% {
    transform: translateY(calc(${h} * -4));
  }
  48% {
    transform: translateY(calc(${h} * -4));
  }
  50% {
    transform: translateY(calc(${h} * -5));
  }
  58% {
    transform: translateY(calc(${h} * -5));
  }
  60% {
    transform: translateY(calc(${h} * -6));
  }
  68% {
    transform: translateY(calc(${h} * -6));
  }
  70% {
    transform: translateY(calc(${h} * -7));
  }
  78% {
    transform: translateY(calc(${h} * -7));
  }
  80% {
    transform: translateY(calc(${h} * -8));
  }
  88% {
    transform: translateY(calc(${h} * -8));
  }
  90% {
    transform: translateY(calc(${h} * -9));
  }
  98% {
    transform: translateY(calc(${h} * -9));
  }
...
export const Rank = styled.aside`
  ...
  > div {
    ...
    ul {
      animation: ${slideupAnimation("34px")} 20s infinite;
      li {
        height: 34px;
        padding: 0 1rem;
        font-weight: 700;
